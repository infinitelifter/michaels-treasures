  ...
  "@graph": [
    {
      ...
      description: `${site.name} is a vintage watch dealer based in Prague, Czechia, run by ${site.legalName}, specialising in watches from the ${site.curatedEra} with a focus on originality and condition.`,
      url: site.url,
      email: site.email,
      identifier: `IČO ${site.ico}`,
      address: {
        "@type": "PostalAddress",
